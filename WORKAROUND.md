# Livewire/AlpineJS ShadowDom workaround

Neither Livewire nor AlpineJS recognize updates to shadow dom elements. For this reason **include the following script on the page where you use @scope/@endscope. Ensure this is executed before AlpineJS is loaded:**
